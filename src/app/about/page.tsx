...
export const metadata: Metadata = {
  title: 'About — XD Studios',
  description: 'Learn about Sanjoy and XD Studios — the creator behind the digital solutions.',
};
...
const timeline = [
  { year: '2022', title: 'Started XD Studios', desc: 'Began freelancing web development and graphic design.' },
          ...
          <div className={styles.heroGrid}>
            <div className={styles.heroContent}>
              ...
              <p className={styles.heroText}>
                I'm a full-stack developer and designer behind XD Studios. I build premium websites, web apps, SaaS products, and brand identities that help individuals and businesses stand out in the digital world.
              </p>
              <p className={styles.heroText}>
